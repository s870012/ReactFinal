      ...
      <div className="container py-5">
        <div className="row">
          <div className="col-10 mx-auto">
            <h2 className="mb-3">活動消息</h2>
            {articles.map((article) => {
              return(
                <div key={article.id} className="d-flex flex-column flex-lg-row mb-4 bg-white shadow">
                  <div className="col-lg-3">
                    <img src={article.image} alt="" style={{width:"100%", height:"100%", objectFit:"cover"}} className="mx-auto d-block"/>
                  </div>
